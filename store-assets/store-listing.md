...
- [ ] Extension ZIP uploaded: `store-assets/patent-cite-tool-chrome-v5.0.1.zip` (~465 KB, manifest.json at ZIP root; manifest version 5.0.1). Firefox/AMO uses `store-assets/patent-cite-tool-firefox-v5.0.1.zip` (separate submission).
...
| Extension ZIP (Chrome) | store-assets/patent-cite-tool-chrome-v5.0.1.zip |
| Extension ZIP (Firefox/AMO) | store-assets/patent-cite-tool-firefox-v5.0.1.zip |
